...
def add_client(clients_list,nif,name,address,phone,email):
    ...
    Args:
      ...
      email
    """
    # (1) se intentaba meter como valor de la clave nif de clients_list otro diccionario con todos los datos
    # (2) he quitado el diccionario que se creaba dentro
    clients_list[nif] = {
              'name': name,
              'address': address,
              'phone': phone,
...
def repartir_cartas(cartas_iniciales,repeticiones):
    ...
    """    
    # (1) da error al intentar hacer más de 2 repeticiones
    combinaciones={}
